...
Práctica 4 Casa
VS Versión 2017
Este programa dibuja cubos para formar un muñeco, utilizando teclas especiales para observar desde distintos angulos 3D
y proporciones para que sean cubos de distientos tamaños*/
#include "Main.h"
