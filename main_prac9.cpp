...
{
	glClearColor(0.5f, 0.5f, 0.5f, 0.0f);				// Gris de fondo	
...
void prisma(GLuint textura1, GLuint textura2)  //Funcion creacion prisma
{
	...
	glAlphaFunc(GL_GREATER, textura1);
...
void display(void)   // Creamos la funcion donde se dibuja
{
	...
	glPopMatrix();
	//Tabla de Ajedrez
	glEnable(GL_ALPHA_TEST); //Intente poner Transparencia pero no pude hacerlo de la manera correcta
